...
# (A separate version of some of these procedures is available for simulation in MARS.
#
#############################################################################################
...
.data
key_array:	.word	0x2d, 0x1C, 0x1A, 0x16, 0x1E, 0x29  		# define as many keycodes here as you need
num_keys:	.word	6					# put the length of the key_array here
...
get_accelX:
	lw	$v1, accel_mmio($0)
	srl	$v1, $v0, 16		# bits 16-24 is X accel (9 bits)
	andi	$v1, $v0, 0x01FF
	jr	$ra

get_accelY:
	lw	$v1, accel_mmio($0)
	andi	$v1, $v0, 0x01FF	# bits 0-8 is Y accel (9 bits)
	jr	$ra
